...
if __name__ == "__main__":
    ...
    train_dataset = get_stack_exchange_paired(data_dir="data/rl", sanity_check=script_args.sanity_check, pct=script_args.train_pct)
    ...
    eval_dataset = get_stack_exchange_paired(data_dir="data/evaluation", sanity_check=True, pct=script_args.train_pct)
